...
Folder ini adalah fondasi utama sebelum masuk ke struktur, likuiditas, sweep, POI, session, dan entry.

Tujuan folder ini bukan membuat pembaca langsung bisa entry, tetapi membangun cara melihat market yang lebih rapi dan bertahap.

Di folder ini, pembaca belajar melihat market sebagai alur pergerakan harga, bukan kumpulan candle acak.
...
- memahami SMC/ICT sebagai cara membaca market, bukan sinyal instan;
- memahami Smart Money secara sehat dan tidak mistis;
- melihat support/resistance sebagai potensi liquidity pool;
- memahami harga bisa bergerak dari satu liquidity ke liquidity lain;
- membuat bias sederhana tanpa memaksakan prediksi;
...
- memahami bahwa liquidity sering menjadi tujuan harga;
- membuat bias sederhana dengan kondisi batal;
